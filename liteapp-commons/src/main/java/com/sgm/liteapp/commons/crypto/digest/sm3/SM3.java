...
import com.sgm.liteapp.commons.crypto.digest.Converter;

public class SM3 {

	public static final byte[] iv = { 115, -128, 22, 111, 73, 20, -78, -71, 23, 36, 66, -41, -38, -118, 6, 0, -87, 111,
			48, -68, 22, 49, 56, -86, -29, -115, -18, 77, -80, -5, 14, 78 };
	...
	private static byte[] bigEndianIntToByte(int num) {
		return back(Converter.intToBytes(num));
	}

	private static int bigEndianByteToInt(byte[] bytes) {
		return Converter.byteToInt(back(bytes));
	}
	...
	public static byte[] padding(byte[] in, int bLen) {
		...
		pos += padd.length;
		byte[] tmp = back(Converter.longToBytes(n));
